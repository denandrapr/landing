...
export default function CountdownV2({ targetDate }: CountdownProps) {
...
function TimeCard({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-col items-center p-4 w-20 py-4">
      <div className={`${inter.className} text-xl font-normal text-white`}>{value}</div>
